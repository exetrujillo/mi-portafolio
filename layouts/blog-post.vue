...
<template>
  <div class="max-w-3xl mx-auto py-8 px-4">
    ...
    <div v-if="$slots.image" class="mb-8 md:full-width-image">
      <div class="w-full max-h-[500px] overflow-hidden rounded-lg shadow-lg border" :style="{ borderColor: 'var(--ui-border)' }">
        <slot name="image" />
      </div>
    </div>
